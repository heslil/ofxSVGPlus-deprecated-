...
static svgtiny_code svgtiny_parse_svg(svgInfo &info,Poco::XML::Element *svg,struct svgtiny_parse_state state,ofPtr<svgNode> currnode);
static svgtiny_code svgtiny_parse_path(Poco::XML::Element *path,struct svgtiny_parse_state state);
static svgtiny_code svgtiny_parse_rect(Poco::XML::Element *rect,struct svgtiny_parse_state state);
static svgtiny_code svgtiny_parse_circle(Poco::XML::Element *circle,struct svgtiny_parse_state state);
static svgtiny_code svgtiny_parse_ellipse(Poco::XML::Element *ellipse,struct svgtiny_parse_state state);
static svgtiny_code svgtiny_parse_line(Poco::XML::Element *line,struct svgtiny_parse_state state);
static svgtiny_code svgtiny_parse_poly(Poco::XML::Element *poly,struct svgtiny_parse_state state, bool polygon);
static svgtiny_code svgtiny_parse_text(Poco::XML::Element *text,struct svgtiny_parse_state state);
static void svgtiny_parse_position_attributes(const Poco::XML::Element *node,const struct svgtiny_parse_state state,float *x, float *y, float *width, float *height);
static void svgtiny_parse_paint_attributes(const Poco::XML::Element *node,struct svgtiny_parse_state *state);
static void svgtiny_parse_font_attributes(const Poco::XML::Element *node,struct svgtiny_parse_state *state);
static void svgtiny_parse_transform_attributes(Poco::XML::Element *node,struct svgtiny_parse_state *state);
 ...
 * Parse a block of memory into a svgtiny_diagram.
 ...
 Return raw XML string in order to modify SVG and save out later.
 Because of the way the DOM parser randomly adds namespace and 
